...
import 静态变量.supermarket.LittleSuperMarket;
import 静态变量.supermarket.MerchandiseV2WithStaticVariable;
...
public class RunLittleSupperMarketAppMain {
    public static void main(String[] args) {
        ...
        System.out.println("MerchandiseV2WithStaticVariable.DISCOUNT_FOR_VIP: " + MerchandiseV2WithStaticVariable.DISCOUNT_FOR_VIP);
