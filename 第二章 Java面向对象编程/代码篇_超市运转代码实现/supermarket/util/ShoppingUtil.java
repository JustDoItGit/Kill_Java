package 代码篇_超市运转代码实现.supermarket.util;

import 代码篇_超市运转代码实现.supermarket.impl.*;
import 代码篇_超市运转代码实现.supermarket.interfaces.*;
...
public class ShoppingUtil {
    ...
    private static Card getRandomVIPCard() {
